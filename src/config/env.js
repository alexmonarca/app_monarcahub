...
export const env = {
  ...
  // Projeto separado para validação de códigos de parceiros comerciais
  partnersSupabaseUrl: import.meta.env.VITE_PARTNERS_SUPABASE_URL ?? "",
  partnersSupabaseAnonKey: import.meta.env.VITE_PARTNERS_SUPABASE_ANON_KEY ?? "",
