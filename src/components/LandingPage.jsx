      ...
      <main>
        ...
        <section id="faq" className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            />
            <FaqItem
              q="Preciso pagar taxa de implementação?"
              a="Sim, a taxa varia conforme a necessidade do seu negócio, fale com um de nossos parceiros comerciais e saiba mais!"
            />
            <FaqItem
              q="Já paguei a taxa de configuração, qual meu próximo passo?"
              a='Ao clicar em "Entrar" aqui na plataforma, você precisa informar o código que nosso Parceiro Representante Comercial passou pra você, depois é só entrar com seu login e senha - se ainda não tiver conta, cadastre-se para receber um convite.'
            />
          </div>
